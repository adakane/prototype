  ...
  return (
    <div class="bg-gray-800 pt-8 ">
      <div class="max-w-6xl m-auto text-gray-800 flex flex-wrap justify-left">
        ...
        <div class="p-5 w-1/2 sm:w-4/12 md:w-3/12">
          ...
          <p class="my-3 block text-gray-300 hover:text-gray-100 text-sm font-medium duration-700">
            Address: 5469 Orchard Ct, Stone Mountain 30083, GA
          </p>

          <div class="flex tem-center justify-center pb-6 md:py-0 md:w-1/2 md:border-b-8 border-gray-800">
            <form>
      ...
      <div class="pt-2">
        ...
        >
          <div class="mt-2">© Copyright 2021-year. All Rights Reserved.</div>
